...
plural.hr = function (p) { var n = Math.abs(p)||0, i = Math.floor(n,10)||0, v = ((p+'').split('.')[1]||'').length, f = Math.floor((p+'').split('.')[1],10)||0, i10 = i % 10, i100 = i % 100, f10 = f % 10, f100 = f % 100; return v === 0 && i10 === 1 && i100 !== 11 || f10 === 1 && f100 !== 11 ? 0 : v === 0 && (i10 >= 2 && i10 <= 4) && !(i100 >= 12 && i100 <= 14) || (f10 >= 2 && f10 <= 4) && !(f100 >= 12 && f100 <= 14) ? 1 : 2; };