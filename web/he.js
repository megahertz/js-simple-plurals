/**
 * Plural rules for the he (Hebrew (modern), עברית) language
 *
...
plural.he = function (p) { var n = Math.abs(p)||0, i = Math.floor(n,10)||0, v = ((p+'').split('.')[1]||'').length, n10 = n % 10; return i === 1 && v === 0 ? 0 : i === 2 && v === 0 ? 1 : v === 0 && !(n >= 0 && n <= 10) && n10 === 0 ? 2 : 3; };