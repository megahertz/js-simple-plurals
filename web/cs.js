/**
 * Plural rules for the cs (Czech, česky, čeština) language
 *
...
plural.cs = function (p) { var n = Math.abs(p)||0, i = Math.floor(n,10)||0, v = ((p+'').split('.')[1]||'').length; return i === 1 && v === 0 ? 0 : (i >= 2 && i <= 4) && v === 0 ? 1 : v !== 0 ? 2 : 3; };