...
plural.dsb = function (p) { var n = Math.abs(p)||0, i = Math.floor(n,10)||0, v = ((p+'').split('.')[1]||'').length, f = Math.floor((p+'').split('.')[1],10)||0, i100 = i % 100, f100 = f % 100; return v === 0 && i100 === 1 || f100 === 1 ? 0 : v === 0 && i100 === 2 || f100 === 2 ? 1 : v === 0 && (i100 >= 3 && i100 <= 4) || (f100 >= 3 && f100 <= 4) ? 2 : 3; };