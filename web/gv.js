...
plural.gv = function (p) { var n = Math.abs(p)||0, i = Math.floor(n,10)||0, v = ((p+'').split('.')[1]||'').length, i10 = i % 10, i100 = i % 100; return v === 0 && i10 === 1 ? 0 : v === 0 && i10 === 2 ? 1 : v === 0 && i100 === 0 || i100 === 20 || i100 === 40 || i100 === 60 || i100 === 80 ? 2 : v !== 0 ? 3 : 4; };