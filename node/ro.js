/**
 * Plural rules for the ro (Romanian, Moldavian, Moldovan, română) language
 *
 ...
 */
module.exports = function (p) { var n = Math.abs(p)||0, i = Math.floor(n,10)||0, v = ((p+'').split('.')[1]||'').length, n100 = n % 100; return i === 1 && v === 0 ? 0 : v !== 0 || n === 0 || n !== 1 && (n100 >= 1 && n100 <= 19) ? 1 : 2; };