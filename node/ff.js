/**
 * Plural rules for the ff (Fula; Fulah; Pulaar; Pular, Fulfulde, Pulaar, Pular) language
 *
 ...
 */
module.exports = function (p) { var n = Math.abs(p)||0, i = Math.floor(n,10)||0; return i === 0 || i === 1 ? 0 : 1; };