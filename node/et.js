/**
 * Plural rules for the et (Estonian, eesti, eesti keel) language
 *
 ...
 */
module.exports = function (p) { var n = Math.abs(p)||0, i = Math.floor(n,10)||0, v = ((p+'').split('.')[1]||'').length; return i === 1 && v === 0 ? 0 : 1; };