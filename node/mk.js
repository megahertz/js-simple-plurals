 ...
 */
module.exports = function (p) { var n = Math.abs(p)||0, i = Math.floor(n,10)||0, v = ((p+'').split('.')[1]||'').length, f = Math.floor((p+'').split('.')[1],10)||0, i10 = i % 10, f10 = f % 10; return v === 0 && i10 === 1 || f10 === 1 ? 0 : 1; };